                ...
                <div class="container pt-0 pt-md-0">
                    <div class="row">
                        <div class="col-lg-9 col-xl-8 col-xxl-7 mx-auto text-center">
                            ...
                            <h3 class="display-4 mb-10">Fruit juice drink</h3>
                        </div>
                        <!-- /column -->
                    </div>
                    <!-- /.row -->
                            ...
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide">
                                    <figure class="rounded"><img src="../assets/img/drink-6.jpg" alt="" />
                                        <div class="project-details d-flex justify-content-center flex-column pt-2">
                                            <div class="post-header">
                                                <h2 class="post-title h3"><a href="javascrip:void(0)" class="link-dark">Grape flavor</a></h2>
                                            </div>
                                            <!-- /.post-header -->
                                        </div>
                                    </figure>
            ...
            <section class="wrapper bg-light pt-10 pt-md-10 pb-20">
                <div class="container pt-0 pt-md-0">
                    <div class="row">
                        <div class="col-lg-9 col-xl-8 col-xxl-7 mx-auto text-center">
                            <h2 class="fs-15 text-uppercase text-muted mb-3">Product</h2>
                            <h3 class="display-4 mb-10">Coffee roaster</h3>
                        </div>
                        <!-- /column -->
                    </div>
                    <!-- /.row -->
            ...
            <section class="wrapper bg-light pt-10 pt-md-10 pb-20">
                <div class="container pt-0 pt-md-0">
                    <div class="row">
                        <div class="col-lg-9 col-xl-8 col-xxl-7 mx-auto text-center">
                            <h2 class="fs-15 text-uppercase text-muted mb-3">Product</h2>
                            <h3 class="display-4 mb-10">Slimming coffee</h3>
                        </div>
                        <!-- /column -->
                    </div>
                    <!-- /.row -->
            ...
            <section class="wrapper bg-light pt-10 pt-md-10 pb-20">
                <div class="container pt-0 pt-md-0">
                    <div class="row">
                        <div class="col-lg-9 col-xl-8 col-xxl-7 mx-auto text-center">
                            <h2 class="fs-15 text-uppercase text-muted mb-3">Product</h2>
                            <h3 class="display-4 mb-10">Energy drinks</h3>
                        </div>
                        <!-- /column -->
                    </div>
                    <!-- /.row -->
            ...
            <section class="wrapper bg-light pt-10 pt-md-10 pb-20">
                <div class="container pt-0 pt-md-0">
                    <div class="row">
                        <div class="col-lg-9 col-xl-8 col-xxl-7 mx-auto text-center">
                            <h2 class="fs-15 text-uppercase text-muted mb-3">Product</h2>
                            <h3 class="display-4 mb-10">Bird's nest drink</h3>
                        </div>
                        <!-- /column -->
                    </div>
                    <!-- /.row -->
