            ...
            <div class="container pt-14 pt-md-16">
                <div class="row">
                    <div class="col-lg-9 col-xl-8 col-xxl-7 mx-auto text-center">
                        <h2 class="fs-15 text-uppercase text-muted mb-3">Recommend</h2>
                        <h3 class="display-4 mb-10">Video introducing our services and how to use them Grace Shopping Mall.</h3>
                    </div>
                    <!-- /column -->
                </div>
                <!-- /.row -->
